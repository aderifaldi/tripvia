...
public class ProfileFragment extends BaseFragment {
    ...
    private CharSequence pagerTitle[] = {"Checked In", "Redeemed"};
    private PagerProfileAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new PagerProfileAdapter(getActivity().getSupportFragmentManager(), pagerTitle, Numboftabs);
        ...
        Glide.with(getActivity()).
                load(GlobalVariable.getUserPhotoURL(getActivity())).
                centerCrop().
                crossFade().
                into(img);

        txt_name.setText(GlobalVariable.getUserName(getActivity()));
        txt_email.setText(GlobalVariable.getUserEmail(getActivity()));


        showLoading();
        Call<ModelProfile> call = apiService.myProfile(GlobalVariable.getUserEmail(getActivity()));
            ...
            public void onResponse(Call<ModelProfile> call, Response<ModelProfile> response) {
                ...
                if (response.isSuccessful()){
                    if (!response.body().isError()){
                        String point = "" + response.body().getData().getTotal_points();
                        String xp =  "" + response.body().getData().getTotal_xp();

                        txt_point.setText(point + " Points, " + xp + " Xp");
                    }
                }
            }
...
//    }
    ...
    protected void logout(){
        ...
        GlobalVariable.saveIsLogin(getActivity(), false);
