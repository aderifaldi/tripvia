...
/**
 * Created by RadyaLabs PC on 05/09/2017.
 */

public class PassPreferences {
    private String PREFS_NAME = "PassCityPointPrefs";
    private String KEY_ACTIVE = "PassCityPointActive";
    private String KEY_DESIGNATED = "PassCityPointDesignated";
    private SharedPreferences preferences;
    private SharedPreferences.Editor editor;

    private String TAG = "PREFERENCES CP TAG";
